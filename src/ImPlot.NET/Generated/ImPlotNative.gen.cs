...
namespace ImPlotNET
{
    public static unsafe partial class ImPlotNative
    {
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotBarsG(byte* label_id, void* getter, void* data, int count, double bar_width);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotBarsHG(byte* label_id, void* getter, void* data, int count, double bar_height);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotDigitalG(byte* label_id, void* getter, void* data, int count);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotLineG(byte* label_id, void* getter, void* data, int count);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotScatterG(byte* label_id, void* getter, void* data, int count);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotShadedG(byte* label_id, void* getter1, void* data1, void* getter2, void* data2, int count);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        ...
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
        public static extern void ImPlot_PlotStairsG(byte* label_id, void* getter, void* data, int count);
        [DllImport("cimplot", CallingConvention = CallingConvention.Cdecl)]
